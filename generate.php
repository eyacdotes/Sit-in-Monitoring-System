...
$query = "SELECT accinfo_idno , accinfo_firstname, accinfo_lastname, purpose, lab, login_time, logout_time , remain_ss FROM sitin INNER JOIN accountinfo ON accountinfo.accinfo_id = sitin.sitin_id WHERE remain_ss = '29'";
